  ...
  "targets": [
    {
      ...
      "include_dir": [
        "/Users/matt/development/electronifie/scratch/bondmath/.node-virtualenv/include/python2.7"
      ],
      "conditions": [
        ['OS=="mac"', {
            "xcode_settings": {
              ...
              "OTHER_LDFLAGS": [
                "-L/Users/matt/development/electronifie/scratch/bondmath/.node-virtualenv/lib/python2.7/config/ -ldl -framework CoreFoundation -lpython2.7"
              ]
            }
        }, { # not OSX
          "cflags": [
